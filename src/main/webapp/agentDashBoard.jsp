...
<html lang="en">
  ...
  <body>
    <div class="dashboard">
      ...
      <div class="sidebar">
        ...
        <ul class="nav-links">
          ...
          <li>
            <a href="agentPageClients.jsp"><i class="fas fa-users"></i>Clients</a>
          </li>
          <li>
    ...
    <!-- Add this right after the notification panel div -->
    <div class="message-panel">
        <div class="message-header">
            <h3>Messages</h3>
            <button class="mark-all-read-msg">Mark all as read</button>
        </div>
